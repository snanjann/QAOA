...
from qaoa import brute_force_maxcut, erqaoa_solve


def main() -> None:
    parser = argparse.ArgumentParser(description="Run ERQAOA for Max-Cut.")
    ...
    assignment, cut, iterations, _ = erqaoa_solve(
        graph,
        p=args.depth,
        n_c=args.threshold,
        k_max=args.k_max,
